    ...
    (function() {
        ...
        qq.FineUploaderBasic = function(o) {
            ...
            this._options = {
                ...
                messages: {
                    typeError: "{file} está em uma extensão inválida. Extensões válidas: {extensions}.",
                    ...
                    minWidthImageError: "Imagem com largura muito pequena.",
                    retryFailTooManyItems: "Tentiva falhou - você atingiu o limite de tentativas.",
                    onLeave: "Os arquivos estão sendo carregados, se você sair agora perderá o progresso.",
                    unsupportedBrowserIos8Safari: "O browser não suporta.  Por favor use o Chrome."
                },
                retry: {
                    enableAuto: false,
                    maxAutoAttempts: 3,
